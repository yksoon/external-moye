...
if [ -z $dirName ]; then
	...
	elif [ "$dirName" == "moye" ]; then
                subDirName="/hicomp/external/$dirName/"
                gitUrl="$gitProtocol$hicompToken@$gitPublicUrl$subDirName$gitRepository.git"

                if [ "$gitRepository" == "front-end" ]; then
                        targetSubDir="/home/hicomp/moye-front"
                else
                        targetSubDir="/home/hicomp/moye-back"
                fi
	else
...
if [ "$dirName" == "jobara" ]; then
	if [ "$gitRepository" == "front-end" ]; then
        ...
        if [ "$gitRepository" == "front-end" ]; then
                jenkinsTargetDir="/home/jenkins-data/workspace/moye-front/"
        else
                jenkinsTargetDir="/home/jenkins-data/workspace/moye-back/"
        fi
else
	jenkinsTargetDir="$jenkinsWorkspace$gitRepository/"
fi
...
if [ "$dirName" == "jobara" ]; then
        ...
        if [ "$gitRepository" == "back-end" ]; then
                echo "git sync dir : `ls -al /home/hicomp/moye-back`"
                cp -rf /home/hicomp/moye-back/* /home/jenkins-data/workspace/moye-back
                echo "copying..."
                echo "jenkins workspace dir : `ls -l /home/jenkins-data/workspace/moye-back/moye-service`"
        else
                echo "git sync dir : `ls -al /home/hicomp/moye-front`"
                cp -rf /home/hicomp/moye-front/* /home/jenkins-data/workspace/moye-front
                echo "copying..."
                rm -rf /home/jenkins-data/workspace/moye-front/web_src
                echo "web_src remove..."
                echo "jenkins workspace dir : `ls -l /home/jenkins-data/workspace/moye-front`"
