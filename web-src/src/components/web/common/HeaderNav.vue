    ...
    <div>
        ...
        <div id="top_right">
            <div id="menu-icon2" class="all_menu">
                <img src="/img/web/main/nav.png" alt="">
            </div>
            <div id="nav">
                <ul>
                    <li>
                        <a :href="routerPath.web_greetings_url" id="nav1">모두의예체능 소개 <span class="arrow"><img
                    ...
                    <li>
                        <a :href="routerPath.web_businessAreas_url" id="nav2">사업소개 <span class="arrow"><img
                                    src="/img/web/main/down_arrow.png" alt="" /></span></a>
                    ...
                    <li>
                        <a :href="routerPath.web_peoples_url" id="nav3">교육서비스 <span class="arrow"><img
                                    src="/img/web/main/down_arrow.png" alt="" /></span></a>
                    ...
                    <li>
                        <a :href="routerPath.web_notices_url" id="nav6">고객센터 <span class="arrow"><img
                                    src="/img/web/main/down_arrow.png" alt="" /></span></a>
